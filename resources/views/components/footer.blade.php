<footer
    class="bg-white p-3 rounded-lg shadow sm:flex sm:items-center sm:justify-between lg:ml-64 sm:ml-0 dark:bg-gray-800 antialiased">
    <p class="mb-4 text-sm text-center text-gray-500 dark:text-gray-400 sm:mb-0">
        &copy; 2019-2022 <a href="https://flowbite.com/" class="hover:underline" target="_blank">Flowbite.com</a>. All
        rights reserved.
    </p>
