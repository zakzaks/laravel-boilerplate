<aside
    ...
    <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
        <ul class="space-y-2">
            <li>
                <a href="{{ route('table') }}"
                    class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group {{ request()->is('table') ? 'bg-gray-100  dark:bg-gray-700 dark:text-white' : 'text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700' }}">
            ...
            <li>
                <a wire.click.prevent
                    class="cursor-pointer flex items-center p-2 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 {{ $formActive ? 'bg-gray-100 dark:bg-gray-700 dark:text-white' : 'text-gray-900' }} {{ $formActive ? 'aria-expanded=true' : '' }}"
                    aria-controls="dropdown-form" data-collapse-toggle="dropdown-form">
                    <svg class="w-6 h-6 text-gray-800 dark:text-white {{ $formActive ? 'rotate-180' : '' }}"
                ...
                <ul id="dropdown-form" class="py-2 space-y-2 {{ $formActive ? '' : 'hidden' }}">
                    <li>
                        <a href="{{ route('form.read') }}"
                            class="{{ request()->is('form/read') ? 'bg-gray-100  dark:bg-gray-700 dark:text-white' : 'text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700' }} flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Read
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('form.add') }}"
                            class="{{ request()->is('form/add') ? 'bg-gray-100  dark:bg-gray-700 dark:text-white' : 'text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700' }} flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Add
                        </a>
                    </li>
                    <li>
